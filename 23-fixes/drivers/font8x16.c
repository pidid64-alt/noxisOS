/* 8x16 bitmap font, ASCII 32..126 (95 glyphs, 16 bytes each).
 * Extracted from the kbd package's default8x16.psfu (public domain
 * console font) at build-authoring time; committed as plain data so
 * the freestanding kernel needs no external files. Row bit 7 = leftmost
 * pixel. Consumed by drivers/fb.c. */
